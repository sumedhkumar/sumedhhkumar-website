      ...
      <div className="hero-grid">
        <div className="hero-copy">
          <div className="hero-pill">
            <span />
            Premium technology work, shaped with clarity
          </div>
          <h1 className="hero-title">
            A sharper technology studio for serious digital work.
          </h1>
          <p className="body-large">
            Vyntegra brings structured thinking, careful execution, and
            premium digital systems into one focused brand experience.
          </p>
